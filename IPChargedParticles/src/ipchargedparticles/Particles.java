...
//                System.out.println("acceletarioIY " + accelerationIY);
//                System.out.println("accelerationIX " + accelerationIX);
//                System.out.println("vx " + currentParticle.vx);
//                System.out.println("vy " + currentParticle.vy);
    ...
    //        for (int i = 0; i < particlesList.size(); i++) {
            for (int i = 0; i < particlesList.size(); i++) {
                ...
                if (particlesList.size() > 1) {
                    ...
                    //System.out.println("index:" + FXMLDocumentController.getIndex());
