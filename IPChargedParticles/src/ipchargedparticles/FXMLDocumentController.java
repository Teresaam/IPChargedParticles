...
public class FXMLDocumentController implements Initializable {
    ...
    private void doneButtonAction(ActionEvent event) {
        ...
        //closes the simulation but not the whole program (goes to the main window)
    }
...
//          XYChart.Series series = new XYChart.Series();
          //series.getData().add(new XYChart.Data(t, Particles.potentialEnergy));
   ...
   public void newAnim(){
    ...
    public void initialize(URL url, ResourceBundle rb) {
       ...
       // animationPane.setBackground(AssetManager.getBackgroundImage());
